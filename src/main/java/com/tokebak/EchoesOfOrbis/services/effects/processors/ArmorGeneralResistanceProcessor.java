...
/**
 * Processor for ARMOR_GENERAL_RESISTANCE. Application is in PlayerStatModifierService (modifier from armor container).
 */
public class ArmorGeneralResistanceProcessor implements EffectProcessor {
