...
/**
 * Processor for RING_THORNS. Application is in ThornsDamageSystem when the player is the damage target.
 */
public class ThornsRingProcessor implements EffectProcessor {
    ...
    public void onDamageDealt(
        ...
        // Thorns applied when player receives damage, not when dealing
    }
}
