...
/**
 * Processor for ARMOR_FIRE_RESISTANCE. Application is in PlayerStatModifierService (modifier from armor container).
 */
public class ArmorFireResistanceProcessor implements EffectProcessor {
