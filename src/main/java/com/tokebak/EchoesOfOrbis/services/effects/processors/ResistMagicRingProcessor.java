...
/**
 * Processor for RING_RESIST_MAGIC. Application is in PlayerStatModifierService (modifier on resist stat from bauble rings).
 */
public class ResistMagicRingProcessor implements EffectProcessor {
