...
/**
 * Processor for ARMOR_PHYSICAL_RESISTANCE. Application is in PlayerStatModifierService (modifier from armor container).
 */
public class ArmorPhysicalResistanceProcessor implements EffectProcessor {
